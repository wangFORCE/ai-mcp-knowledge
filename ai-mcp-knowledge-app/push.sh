...
ALIYUN_REGISTRY="crpi-owaqg104xalvirb6.cn-hangzhou.personal.cr.aliyuncs.com"
NAMESPACE="wangbiggun"
IMAGE_NAME="ai-mcp-knowledge-app"
IMAGE_TAG="1.1"

# Login to Aliyun Docker Registry
echo "Logging into Aliyun Docker Registry..."
docker login --username="wrnmb11" --password="wlk20021013" $ALIYUN_REGISTRY
